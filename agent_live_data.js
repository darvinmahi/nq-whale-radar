...
// Generated: 2026-03-27T18:38:14.337969Z
// ═══════════════════════════════════════════════════════

window.NQ_LIVE = {
  timestamp:   "2026-03-27T18:38:14.337969Z",
  last_update: "27 Mar 2026 18:38 UTC",

  NDX: { price: 23176.22, change_pct: -1.74 },
  VXN: { price: 33.38, change_pct: 11.79, color: "#ef4444" },
  MACRO: {
    US10Y: { price: null, change_pct: null },
    DXY:   { price: 100.17, change_pct: 0.27 }
  },
  ...
  BIAS: {
    ...
    verdict:        "NEUTRAL",
    icon:           "⚪",
    breakdown:      {"positioning": 50, "macro": 48.65, "liquidity": 40.0, "timing": 44.0, "algorithmic": 66.0, "order_flow": 50}
  },

  SESSIONS:  {},
  SMC:       {"agent": 6, "name": "ICT & SMC Master", "timestamp": "2026-03-27T18:38:14.267012Z", "ict": {"pd_array": "DISCOUNT", "equilibrium": 24816.595703125, "has_liquidity_sweep": "BULLISH"}, "smc": {"last_bull_ob_price": 24455.400390625, "fvg_status": "ZONA_COMPRA", "institution_bias": "BULLISH"}, "signal": "BULLISH", "confidence": 85, "details": "ICT SETUP: Liquidity Sweep en zona de DISCOUNT detectado. Alta probabilidad alcista."},
  PROB:      {"agent": 7, "name": "Probability Analyst", "version": "2.0", "timestamp": "2026-03-27T18:38:14.260315+00:00", "signals_used": [{"name": "COT", "raw_signal": "BAJISTA", "weight": 0.35}, {"name": "SMC", "raw_signal": "BULLISH", "weight": 0.4}, {"name": "OrderFlow", "raw_signal": null, "weight": 0.25}], "signals_aligned": 1, "signals_neutral": ["OrderFlow"], "confluences": {"label": "SE\u00d1AL AISLADA (1/3)", "cot_smc_match": false, "expectancy_pct": 52.5, "confidence_pct": 40.0, "weighted_score": 0.05, "vol_regime": "UNKNOWN", "vol_multiplier": 1.0}, "verdict": "DISTRIBUCI\u00d3N / NEUTRAL \u2014 ESPERAR CLARIDAD \u23f3", "math_bias": "NEUTRAL"},
  MINDSET:   {"agent": 8, "name": "Morgan Psychologist", "timestamp": "2026-03-27T18:38:14.259658+00:00", "sentiment": {"status": "ALERTA: P\u00c1NICO EXTREMO", "operational_risk": "ALTO (Volatilidad Desatada)", "alerts": ["Capitulaci\u00f3n en curso. El mercado est\u00e1 barriendo manos d\u00e9biles. Busca niveles SMC para soporte."]}, "morgan_audit": {"institutional_alignment": "LOW", "fear_index": "HIGH"}},
  SB:        {"agent": 9, "name": "Silver Bullet Tracker", "timestamp": "2026-03-27T18:38:14.258629+00:00Z", "ny_time": "14:38", "status": "ACTIVE", "active_window": "NY PM SB", "macro_confluence": "NEUTRAL", "action": "BUSCAR FVG PARA ENTRADA", "countdown": "22 min restantes"},
