...
// Generated: 2026-03-19T03:03:09.346418Z
// ═══════════════════════════════════════════════════════

window.NQ_LIVE = {
  timestamp:   "2026-03-19T03:03:09.346418Z",
  last_update: "19 Mar 2026 03:03 UTC",

  NDX: { price: 24425.09, change_pct: -1.43 },
  VXN: { price: 27.72, change_pct: 12.41, color: "#eab308" },
  MACRO: {
  ...
  COT: {
    net:            -89615,
    commercial_net: 12450,
    index:          42,
    signal:         "BEARISH",
    razonamiento:   "Asset Managers redujeron posiciones netas por 3ª semana consecutiva. COT Index en zona bajista (42/100). Precaución: distribución institucional activa.",
    consecutive_weeks: -3,
    oi:             285320,
    recent_weeks: [
      { date: "2026-02-14", net: -72100, index: 58 },
      { date: "2026-02-21", net: -78340, index: 52 },
      { date: "2026-02-28", net: -82190, index: 48 },
      { date: "2026-03-07", net: -85470, index: 45 },
      { date: "2026-03-14", net: -89615, index: 42 }
    ]
  },
  ...
  BIAS: {
    ...
    verdict:        "NEUTRAL",
    icon:           "⚪",
    breakdown:      {"positioning": 24, "macro": 50, "liquidity": 41.0, "timing": 53.5, "algorithmic": 66.0, "order_flow": 50}
  },

  SESSIONS:  {},
  SMC:       {"agent": 6, "name": "ICT & SMC Master", "timestamp": "2026-03-19T03:03:09.243208Z", "ict": {"pd_array": "DISCOUNT", "equilibrium": 24816.595703125, "has_liquidity_sweep": "BULLISH"}, "smc": {"last_bull_ob_price": 24455.400390625, "fvg_status": "ZONA_COMPRA", "institution_bias": "BULLISH"}, "signal": "BULLISH", "confidence": 85, "details": "ICT SETUP: Liquidity Sweep en zona de DISCOUNT detectado. Alta probabilidad alcista."},
  PROB:      {"agent": 7, "name": "Probability Analyst", "version": "2.0", "timestamp": "2026-03-19T03:03:09.211990+00:00", "signals_used": [{"name": "COT", "raw_signal": "BEARISH", "weight": 0.35}, {"name": "SMC", "raw_signal": "BULLISH", "weight": 0.4}, {"name": "OrderFlow", "raw_signal": null, "weight": 0.25}], "signals_aligned": 1, "signals_neutral": ["OrderFlow"], "confluences": {"label": "SE\u00d1AL AISLADA (1/3)", "cot_smc_match": false, "expectancy_pct": 52.5, "confidence_pct": 40.0, "weighted_score": 0.05, "vol_regime": "UNKNOWN", "vol_multiplier": 1.0}, "verdict": "DISTRIBUCI\u00d3N / NEUTRAL \u2014 ESPERAR CLARIDAD \u23f3", "math_bias": "NEUTRAL"},
  MINDSET:   {"agent": 8, "name": "Morgan Psychologist", "timestamp": "2026-03-19T03:03:09.209976+00:00", "sentiment": {"status": "ESTABLE", "operational_risk": "BAJO", "alerts": ["Sentimiento equilibrado. Ejecuci\u00f3n t\u00e9cnica recomendada."]}, "morgan_audit": {"institutional_alignment": "HIGH", "fear_index": "MEDIUM"}},
  SB:        {"agent": 9, "name": "Silver Bullet Tracker", "timestamp": "2026-03-19T03:03:09.208878+00:00Z", "ny_time": "23:03", "status": "INACTIVO", "active_window": "London SB (ma\u00f1ana)", "macro_confluence": "NEUTRAL-BULLISH", "action": "ESPERAR VENTANA", "countdown": "Pr\u00f3xima sesi\u00f3n en 3h 57m"},
