...
// Generated: 2026-08-07T16:13:49.802633Z
// ═══════════════════════════════════════════════════════

window.NQ_LIVE = {
  timestamp:   "2026-08-07T16:13:49.802633Z",
  last_update: "07 Aug 2026 16:13 UTC",

  NDX: { price: 29700.74, change_pct: 1.11 },
  VXN: { price: 23.02, change_pct: -3.88, color: "#eab308" },
  MACRO: {
    US10Y: { price: null, change_pct: null },
    DXY:   { price: 99.56, change_pct: -0.41 }
  },
  ...
  BIAS: {
    ...
    verdict:        "NEUTRAL",
    icon:           "⚪",
    breakdown:      {"positioning": 50, "macro": 52.05, "liquidity": 58.0, "timing": 56.0, "algorithmic": 20.0, "order_flow": 50}
  },

  SESSIONS:  {},
  SMC:       {"agent": 6, "name": "ICT & SMC Master", "timestamp": "2026-08-07T16:13:42.633701Z", "ict": {"pd_array": "PREMIUM", "equilibrium": 24816.595703125, "has_liquidity_sweep": "BULLISH"}, "smc": {"last_bull_ob_price": 24455.400390625, "fvg_status": "NEUTRAL", "institution_bias": "BEARISH"}, "signal": "BEARISH", "confidence": 85, "details": "ICT SETUP: Liquidity Sweep en zona de PREMIUM detectado. Riesgo de reversi\u00f3n bajista."},
  PROB:      {"agent": 7, "name": "Probability Analyst", "version": "2.0", "timestamp": "2026-08-07T16:13:42.626864+00:00", "signals_used": [{"name": "COT", "raw_signal": "NEUTRAL-BAJISTA", "weight": 0.35}, {"name": "SMC", "raw_signal": "BEARISH", "weight": 0.4}, {"name": "OrderFlow", "raw_signal": null, "weight": 0.25}], "signals_aligned": 2, "signals_neutral": ["OrderFlow"], "confluences": {"label": "DOBLE CONFLUENCIA (2/3)", "cot_smc_match": true, "expectancy_pct": 12.5, "confidence_pct": 75.0, "weighted_score": -0.75, "vol_regime": "UNKNOWN", "vol_multiplier": 1.0}, "verdict": "ALTA PROBABILIDAD BAJISTA \ud83d\udd3b", "math_bias": "BEARISH"},
  MINDSET:   {"agent": 8, "name": "Morgan Psychologist", "timestamp": "2026-08-07T16:13:42.627370+00:00", "sentiment": {"status": "ESTABLE", "operational_risk": "BAJO", "alerts": ["Sentimiento equilibrado. Ejecuci\u00f3n t\u00e9cnica recomendada."]}, "morgan_audit": {"institutional_alignment": "LOW", "fear_index": "MEDIUM"}},
  SB:        {"agent": 9, "name": "Silver Bullet Tracker", "timestamp": "2026-08-07T16:13:42.625743+00:00Z", "ny_time": "12:13", "status": "UPCOMING", "active_window": "NY PM SB", "macro_confluence": "NEUTRAL", "action": "ESPERAR VENTANA", "countdown": "En 1h 47m"},
