...
// Generated: 2026-03-25T19:36:15.303748Z
// ═══════════════════════════════════════════════════════

window.NQ_LIVE = {
  timestamp:   "2026-03-25T19:36:15.303748Z",
  last_update: "25 Mar 2026 19:36 UTC",

  NDX: { price: 24129.72, change_pct: 0.53 },
  VXN: { price: 27.69, change_pct: -3.65, color: "#eab308" },
  MACRO: {
    US10Y: { price: null, change_pct: null },
    DXY:   { price: 99.62, change_pct: 0.19 }
  },
  ...
  BIAS: {
    ...
    icon:           "🔵",
    breakdown:      {"positioning": 50, "macro": 49.05, "liquidity": 49.0, "timing": 56.0, "algorithmic": 66.0, "order_flow": 50}
  },

  SESSIONS:  {},
  SMC:       {"agent": 6, "name": "ICT & SMC Master", "timestamp": "2026-03-25T19:36:15.255242Z", "ict": {"pd_array": "DISCOUNT", "equilibrium": 24816.595703125, "has_liquidity_sweep": "BULLISH"}, "smc": {"last_bull_ob_price": 24455.400390625, "fvg_status": "ZONA_COMPRA", "institution_bias": "BULLISH"}, "signal": "BULLISH", "confidence": 85, "details": "ICT SETUP: Liquidity Sweep en zona de DISCOUNT detectado. Alta probabilidad alcista."},
  PROB:      {"agent": 7, "name": "Probability Analyst", "version": "2.0", "timestamp": "2026-03-25T19:36:15.248123+00:00", "signals_used": [{"name": "COT", "raw_signal": "BAJISTA", "weight": 0.35}, {"name": "SMC", "raw_signal": "BULLISH", "weight": 0.4}, {"name": "OrderFlow", "raw_signal": null, "weight": 0.25}], "signals_aligned": 1, "signals_neutral": ["OrderFlow"], "confluences": {"label": "SE\u00d1AL AISLADA (1/3)", "cot_smc_match": false, "expectancy_pct": 52.5, "confidence_pct": 40.0, "weighted_score": 0.05, "vol_regime": "UNKNOWN", "vol_multiplier": 1.0}, "verdict": "DISTRIBUCI\u00d3N / NEUTRAL \u2014 ESPERAR CLARIDAD \u23f3", "math_bias": "NEUTRAL"},
  MINDSET:   {"agent": 8, "name": "Morgan Psychologist", "timestamp": "2026-03-25T19:36:15.248778+00:00", "sentiment": {"status": "ESTABLE", "operational_risk": "BAJO", "alerts": ["Sentimiento equilibrado. Ejecuci\u00f3n t\u00e9cnica recomendada."]}, "morgan_audit": {"institutional_alignment": "LOW", "fear_index": "MEDIUM"}},
  SB:        {"agent": 9, "name": "Silver Bullet Tracker", "timestamp": "2026-03-25T19:36:15.248615+00:00Z", "ny_time": "15:36", "status": "INACTIVO", "active_window": "London SB (ma\u00f1ana)", "macro_confluence": "NEUTRAL-BULLISH", "action": "ESPERAR VENTANA", "countdown": "Pr\u00f3xima sesi\u00f3n en 11h 24m"},
